...
class Migration_Create_Duty extends CI_Migration {
    ...
    public function up()
    {
        ...
        $this->db->query("
            ...
            {$prefix}_group_id INT(14) UNSIGNED NULL ,
            ...
            CONSTRAINT duty_fk_group FOREIGN KEY ({$prefix}_group_id) REFERENCES {$this->db->dbprefix("group")} (grp_id) ON DELETE CASCADE ON UPDATE CASCADE ,
