...
$config['admin_menu'] = array(
    ...
    "وظیفه" => array("address" => "admin/dashboard" ,
         ...
         "active" =>FALSE ,
         "submenu" => array(
            "اضافه کردن وظیفه" => array("address" => "admin/dash_reminder/add_reminder" ,
                "icon" =>"glyphicon glyphicon-tasks" ,
                "active" =>FALSE) ,
            "وظیفه های ایجاد شده" => array("address" => "admin/dash_reminder/add_noted" ,
                "icon" =>"glyphicon glyphicon-tasks" ,
                "active" =>FALSE) ,
            "وظیفه های مربوط به خود" => array("address" => "admin/dash_reminder/my_reminder_list" ,
                "icon" =>"glyphicon glyphicon-tasks" ,
                "active" =>FALSE) ,
         )) ,
